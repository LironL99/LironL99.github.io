...
This repository includes two significant tasks focusing on VLSI design. These projects involve:
- **MOSFET, Inverter & Buffer Design** – Optimizing and designing fundamental digital components.
- **Digital Logic Blocks** – Designing and testing adders, multiplexers, and barrel shifters.
...
A series of assignments that demonstrate my proficiency in C++ systems programming, covering topics like memory management and concurrency.
